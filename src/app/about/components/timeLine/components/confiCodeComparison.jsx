...
export function CodeComparison({
    ...
    if (highlighted) {
      return (
        <div
          ...
          className={cn(
            "bg-[#00000027] !h-full w-full overflow-auto font-mono text-[3.15px]",
            "[&>pre]:h-full [&>pre]:!w-full [&>pre]:py-2 [&>pre]:!bg-[#00000027]",
            "[&>pre>code]:!inline-block [&>pre>code]:!w-full [&>pre>code]:text-[3.15px] [&>pre>code]:leading-tight",
            "[&>pre>code>span]:!inline-block [&>pre>code>span]:w-full [&>pre>code>span]:px-2 [&>pre>code>span]:py-0",
      ...
      return (
        <pre className="text-gray-200 h-full overflow-auto p-2 font-mono text-[5px] leading-tight break-all">
          {code}
        </pre>
      )
    }
  ...
  return (
    <div className="mx-auto w-full h-full  max-w-5xl">
      <div className="group border-[#ffffff11] relative w-full h-full overflow-hidden rounded-2xl border">
        <div className="relative h-full grid grid-cols-2">
          <div
            className={cn(
              "leftside group/left border-[#ffffff11] md:border-r",
              hasLeftFocus &&
          ...
          >
            <div className="border-[#ffffff11] text-gray-200 flex items-center border-b p-2 text-xs">
          ...
          <div
            className={cn(
              "rightside group/right border-[#ffffff11] border-t md:border-t-0",
              hasRightFocus &&
                "[&>div>pre>code>:not(.focused)]:!opacity-50 [&>div>pre>code>:not(.focused)]:!blur-[0.095rem]",
              "[&>div>pre>code>:not(.focused)]:transition-all [&>div>pre>code>:not(.focused)]:duration-300"
            )}
        ...
        <div className="border-[#ffffff11] bg-[#00000027] text-gray-200 absolute top-1/2 left-1/2 hidden h-8 w-8 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-2xl border text-xs md:flex">
          VS
        </div>
      </div>
    </div>
