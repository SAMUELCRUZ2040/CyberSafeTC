...
export default function Combobox() {
  return (
    <ul className={`bg-[#ffffff05] transition ease-in-out backdrop-blur-lg absolute top-[109%] left-8 hidden py-8 p-2 border-2 rounded-3xl  flex-col gap-5 w-[25rem] h-[23rem] overflow-y-scroll`} style={{borderTopLeftRadius : "0"}}>
