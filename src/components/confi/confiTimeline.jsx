      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        ...
        <div
          ...
          <motion.div
            ...
            className="absolute inset-x-0 top-0  w-[2px] bg-gradient-to-t from-[#67deff] via-[#8c3ff79b] to-transparent from-[0%] via-[10%] rounded-full" />
        </div>
      </div>
    </div>)
  );
