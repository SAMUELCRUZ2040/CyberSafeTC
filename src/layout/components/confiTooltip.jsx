      ...
      {items.map((item, idx) => (
        <div
          ...
          <Image
            ...
            src={item.image}
            alt={item.name}
            className="relative !m-0 h-[4rem] w-[4rem] rounded-full border-2 border-white object-cover object-top !p-0 transition duration-500 group-hover:z-30 group-hover:scale-105" />
        </div>
      ))}
    </>
  );
