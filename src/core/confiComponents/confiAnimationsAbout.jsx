...
const X = {
    count: 30,
    colors: ["#6cff00", "#00f7ff", "#00d1ff"], // Changed to white and blue
    ambientColor: 9498256,
    ambientIntensity: 1,
    lightIntensity: 10,
    materialParams: {
        metalness: 0.5,
...
const ConfiAnimationsAbout = ({ className = '', followCursor = true, ...props }) => {
...
export default ConfiAnimationsAbout;
